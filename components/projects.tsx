                ...
                >
                    ...
                    <div className="col-span-1 md:col-span-2 lg:col-span-3 flex justify-center">
                        <motion.div
                            ...
                            whileHover={{ y: -10 }}
                            transition={{ type: "spring", stiffness: 300, damping: 15 }}
                            className="glass-strong rounded-xl overflow-hidden shadow-xl border border-white/10 hover:border-cyan-500/30 p-10 flex flex-col items-center justify-center min-h-[280px] group w-full max-w-lg"
                        >
                            <div className="relative w-16 h-16 mb-6">
                                ...
                                <div className="relative w-16 h-16 bg-blue-600/20 rounded-full flex items-center justify-center group-hover:bg-blue-600/30 transition-colors">
                                    <HiSparkles className="w-8 h-8 text-cyan-400 group-hover:text-cyan-300" />
                                </div>
                            </div>
                            <h3 className="text-2xl font-bold text-white mb-3 text-center">{t('myprojects.comingSoon.title')}</h3>
                            <p className="text-gray-400 text-center max-w-sm">{t('myprojects.comingSoon.description')}</p>
                            <motion.button
